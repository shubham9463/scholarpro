...
// Olympiad Pages (Science, Maths, English, Computer, Essay, Drawing)
...
import StudentDashboard from "./components/pages/StudentDasboard.jsx"; 
import SchoolDashboard from "./components/pages/SchoolDashboard.jsx";
  ...
  return (
    <div className="app-container">
      ...
      <Routes>
        ...
        <Route path="/student-dashboard" element={<StudentDashboard />} /> {/* ✅ Navbar + Footer visible */}
